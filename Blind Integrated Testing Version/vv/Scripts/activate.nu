...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\agast\OneDrive\Desktop\niks\python\attend_track_image\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\agast\OneDrive\Desktop\niks\python\attend_track_image\venv\Scripts\deactivate.nu'
