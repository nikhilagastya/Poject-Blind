...
__all__ = [
    'SPEI_TTS_BOOKMARK', 'DISPID_SPPChildren', 'SSSPTRelativeToStart',
    'SpStreamFormatConverter', 'STSF_AppData',
    'DISPID_SRRSetTextFeedback', 'SGDSActiveUserDelimited',
    'ISpeechRecoContext', '_RemotableHandle', 'SAFT48kHz8BitStereo',
    'eLEXTYPE_RESERVED4', 'ISpeechRecoGrammar', 'DISPID_SPRsItem',
    'SPSNoun', 'SASPause', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPCIdToPhone',
    'SpeechLexiconType', 'DISPID_SRRPhraseInfo', 'SPRECOGNIZERSTATUS',
    'ISpeechFileStream', 'SRTStandard', 'SpeechVoiceCategoryTTSRate',
    'SRTSMLTimeout', 'SVSFParseSapi', 'DISPID_SPRuleNumberOfElements',
    'SpFileStream', 'SAFT44kHz8BitMono', 'SPEI_PROPERTY_NUM_CHANGE',
    ...
    'SRESoundStart', 'SSFMOpenReadWrite', 'DISPID_SMSADeviceId',
    'SASClosed', 'DISPID_SVVolume', 'SpTextSelectionInformation',
    'DISPID_SVAlertBoundary', 'DISPID_SASState', 'SP_VISEME_14',
    'SP_VISEME_4', 'SpeechRuleAttributes',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPBO_PAUSE', 'SVP_4', 'SRARoot',
    'eLEXTYPE_PRIVATE17', 'DISPID_SRCERequestUI',
    ...
    'ISpeechDataKey', 'SAFT11kHz8BitStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPCT_SLEEP',
    'ISpeechPhraseReplacement', 'DISPID_SOTCDefault',
    'DISPID_SLWWord', 'SPSLMA', 'SpeechTokenContext',
    'SWPUnknownWordPronounceable', 'SAFT24kHz8BitStereo', 'SVP_7',
    'SAFT48kHz16BitStereo', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPGRAMMARSTATE', 'SAFT12kHz8BitMono',
    'SpeechStreamSeekPositionType', 'SSTTTextBuffer', 'SRADynamic',
    'SpeechDisplayAttributes', 'SPRS_INACTIVE',
    'DISPID_SpeechRecoResult', 'SPSHORTCUTPAIR', 'DISPID_SGRSTType',
    'DISPID_SLPsCount', 'SpObjectTokenCategory',
    'SGDSActiveWithAutoPause', 'SPDKL_CurrentConfig',
    'SPXMLRESULTOPTIONS', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SDTPronunciation', 'ISpeechObjectToken',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRCreateRecoContext',
    'SpeechVisemeFeature', 'SINone', 'SpeechRuleState',
    'Speech_Max_Word_Length', 'DISPID_SGRSTRule', 'SPLO_STATIC',
    'SPRST_ACTIVE_ALWAYS', 'SPPROPERTYINFO', 'DISPID_SPCPhoneToId',
    'SpCompressedLexicon', 'DISPID_SpeechPhraseRules', 'SPSFunction',
    'SPSHT_NotOverriden', 'DISPID_SGRAddState', 'SPVOICESTATUS',
    'SREHypothesis', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechRecoContext', 'ISpeechAudioStatus',
    'DISPID_SOTCreateInstance', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechVoiceStatus', 'SSSPTRelativeToEnd',
    'ISpeechRecoResult', 'DISPID_SpeechDataKey', 'SVSFParseSsml',
    'SASStop', 'SpInprocRecognizer', 'DISPID_SRCPause', 'SPAS_STOP',
    'SECHighConfidence', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SLWsCount', 'Speech_StreamPos_Asap', 'SP_VISEME_8',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SLTUser',
    'SAFTADPCM_44kHzStereo', 'ISpStreamFormat', 'SPINTERFERENCE_NONE',
    'DISPID_SpeechVoice', 'SVEPrivate', 'DISPID_SRGCommit',
    'SPPHRASERULE', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechObjectTokens', 'SRTReSent',
    'DISPID_SRGCmdLoadFromResource', 'SSFMCreateForWrite',
    'SSTTWildcard', 'DISPID_SpeechPhraseRule',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPPValue', 'SVP_14',
    'DISPID_SRCEInterference', 'SPPS_RESERVED4',
    'DISPID_SGRSTs_NewEnum', 'eLEXTYPE_RESERVED10',
    'SpeechCategoryPhoneConverters', 'ISpDataKey',
    'DISPID_SRCERecognitionForOtherContext', 'Speech_Default_Weight',
    'SVSFlagsAsync', 'SPSERIALIZEDRESULT', 'ISpNotifySink',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SpeechVoicePriority',
    'SGLexicalNoSpecialChars', 'SPCT_DICTATION', 'ISpRecoGrammar',
    'SWPKnownWordPronounceable', 'DISPID_SRCEPropertyStringChange',
    'STCRemoteServer', 'SPEI_REQUEST_UI', 'SPFM_CREATE_ALWAYS',
    'SPEI_SR_BOOKMARK', 'SpeechRecoEvents', 'SRAONone',
    ...
    'DISPID_SRRTimes', 'DISPID_SPIAudioSizeBytes', 'DISPID_SVResume',
    'DISPID_SPIAudioStreamPosition', 'ISpRecognizer3',
    'SECFIgnoreWidth', 'eLEXTYPE_PRIVATE15', 'SVSFParseAutodetect',
    'ISpeechGrammarRuleState', 'ISpeechLexicon', 'SP_VISEME_13',
    'DISPID_SPAsItem', 'DISPID_SPIStartTime', 'SAFT32kHz16BitStereo',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpeechVoice',
    'SECFNoSpecialChars', 'SPAR_Medium', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVDisplayUI', 'eLEXTYPE_PRIVATE6',
    'SAFTExtendedAudioFormat', 'DISPID_SOTSetId',
    'SAFTADPCM_8kHzMono', 'SPCT_COMMAND', 'UINT_PTR',
    'SpeechCategoryAppLexicons', 'STSF_LocalAppData',
    'SAFT22kHz16BitStereo', 'SAFTCCITT_uLaw_44kHzStereo',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRAddResource', 'SITooQuiet',
    'SPVPRIORITY', 'SAFT8kHz16BitStereo', 'DISPID_SGRSTNextState',
    'ISpeechRecoResultDispatch', 'SPINTERFERENCE_TOOFAST',
    'SPPS_NotOverriden', 'DISPID_SPARecoResult',
    'SpeechCategoryRecoProfiles', 'SpeechBookmarkOptions',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCVoice',
    'ISpeechWaveFormatEx', 'SVP_2', 'DISPID_SGRInitialState',
    'DISPID_SPEs_NewEnum', 'SAFT32kHz8BitMono', 'SPPS_Noun',
    'SP_VISEME_21', 'SDTAll', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRCEStartStream', 'DISPID_SAFGuid',
    'SpeechRecognitionType', 'ISpeechLexiconPronunciations',
    'DISPID_SABIMinNotification', 'SPINTERFERENCE_TOOQUIET',
    'SSTTDictation', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SCSBaseStream', 'DISPID_SRRGetXMLResult',
    'eLEXTYPE_PRIVATE5', 'SREAdaptation', 'DISPIDSPTSI',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SVEventInterests',
    'SGDisplay', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SDKGetStringValue',
    'SVF_Stressed', 'SpeechAudioProperties', 'ISequentialStream',
    'SpeechPropertyLowConfidenceThreshold', 'SVP_3',
    'SpSharedRecoContext', 'SPEI_END_SR_STREAM',
    'ISpeechLexiconPronunciation', 'DISPID_SPEDisplayAttributes',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_PHONEME', 'SVP_11',
    'SVSFIsFilename', 'DISPID_SPAStartElementInResult',
    'ISpRecognizer2', 'ISpeechResourceLoader', 'SREStateChange',
    'SpNotifyTranslator', 'SLOStatic', 'DISPID_SMSALineId',
    'SPGS_ENABLED', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechPhraseReplacement',
    'ISpPhraseAlt', 'DISPID_SOTMatchesAttributes', 'SPVPRI_NORMAL',
    ...
    'SPFILEMODE', 'DISPID_SRGCmdLoadFromObject', 'SPSERIALIZEDPHRASE',
    'SpeechPropertyResourceUsage', 'SGSExclusive',
    'DISPID_SPPs_NewEnum', 'DISPID_SVStatus', 'SVSFUnusedFlags',
    'SPRECOSTATE', 'SSFMCreate', 'DISPID_SRRGetXMLErrorInfo',
    'SP_VISEME_2', 'SPRST_INACTIVE', 'DISPID_SMSSetData',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SGRName',
    'ISpPhoneticAlphabetSelection', 'DISPID_SFSOpen',
    'DISPID_SRCRequestedUIType', 'SAFT12kHz8BitStereo',
    'DISPID_SBSFormat', 'SAFTCCITT_ALaw_11kHzMono', 'SBONone',
    'SpeechCategoryAudioOut', 'DISPID_SpeechPhraseInfo',
    'DISPID_SPRDisplayAttributes', 'SpeechAudioFormatType',
    'ISpeechPhraseReplacements', 'SpeechWordType', 'SREStreamEnd',
    'DISPID_SpeechPhraseElements', 'SAFT8kHz16BitMono',
    'DISPID_SVSLastResult', 'ISpStream', 'DISPID_SVPause',
    'SAFT16kHz16BitMono', 'SpCustomStream', 'SpeechLoadOption',
    'DISPID_SVSVisemeId', 'SITooFast', 'SGSDisabled',
    'ISpeechRecognizer', 'SP_VISEME_19', 'DISPID_SRGReset',
    'SAFTADPCM_22kHzMono', 'DISPID_SWFESamplesPerSec',
    'ISpeechObjectTokens', 'SPAUDIOBUFFERINFO',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechXMLRecoResult',
    'SPPHRASEPROPERTY', 'SGRSTTRule', 'STCAll',
    'DISPID_SRAudioInputStream', 'DISPID_SVEEnginePrivate',
    'SpMMAudioEnum', 'SAFTNonStandardFormat', 'DISPID_SVAudioOutput',
    'DISPID_SLGenerationId', 'DISPID_SpeechCustomStream',
    'DISPID_SPEsCount', 'SPSUnknown', 'DISPID_SOTCSetId', 'SRAExport',
    'DISPID_SOTDisplayUI', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPEI_RESERVED3', 'SpeechTokenShellFolder', 'DISPID_SRDisplayUI',
    'DISPID_SRGCmdSetRuleIdState', 'SPBOOKMARKOPTIONS',
    'DISPID_SRRAudio', 'SPEI_VOICE_CHANGE', 'SP_VISEME_12',
    'STSF_CommonAppData', 'SpeechVoiceSpeakFlags',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRCEPhraseStart',
    'DISPID_SPPsCount', 'SpMMAudioOut', 'SPWT_DISPLAY', 'SP_VISEME_6',
    'SPRST_NUM_STATES', 'DISPID_SPRulesCount', 'SPSHORTCUTPAIRLIST',
    'SVF_Emphasis', 'DISPID_SGRSTPropertyValue',
    'SREFalseRecognition', 'SPDATAKEYLOCATION',
    'ISpPhoneticAlphabetConverter', 'DISPID_SPEsItem',
    'ISpObjectWithToken', 'DISPID_SPERequiredConfidence',
    'DISPID_SRRSaveToMemory', 'SAFTADPCM_8kHzStereo',
    'SpeechVoiceEvents', 'DISPID_SpeechAudioStatus', 'SRATopLevel',
    'DISPID_SVSInputSentencePosition', 'ISpeechPhraseAlternates',
    'SAFTGSM610_8kHzMono', 'DISPID_SDKSetBinaryValue',
    'DISPIDSPTSI_ActiveLength', 'SPGRAMMARWORDTYPE',
    'eLEXTYPE_PRIVATE1', 'SRSActive', 'DISPID_SGRSTsCount',
    'SPEI_SOUND_START', 'SAFT22kHz8BitMono', 'SpeechCategoryVoices',
    ...
    'DISPID_SOTs_NewEnum', 'eLEXTYPE_PRIVATE14',
    'ISpeechPhraseProperties', 'DISPID_SPRsCount', 'ISpVoice',
    'DISPID_SPIProperties', 'SAFT16kHz8BitMono', 'SPAUDIOSTATE',
    'eLEXTYPE_PRIVATE7', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SpeechVoiceEvent',
    'SPPHRASEREPLACEMENT', 'DISPID_SPIAudioSizeTime',
    'DISPID_SVVoice', 'DISPID_SGRSRule', 'SVP_13',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRSetPropertyString',
    'SPSTREAMFORMATTYPE', 'SRCS_Disabled',
    'DISPID_SASFreeBufferSpace', 'ISpeechRecoResultTimes',
    'SpeechPropertyComplexResponseSpeed', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRCResume', 'SP_VISEME_3', 'DISPID_SVSInputWordPosition',
    'SP_VISEME_1', 'DISPID_SASetState', 'SAFTADPCM_11kHzStereo',
    'SGRSTTWildcard', 'ISpeechBaseStream', 'DISPID_SPPFirstElement',
    'SVEStartInputStream', 'SPSNotOverriden',
    'ISpStreamFormatConverter',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SMSAMMHandle', 'SPEI_PHRASE_START', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechRecognizer', 'DISPID_SAEventHandle',
    'DISPID_SPAs_NewEnum', 'ISpLexicon', 'DISPID_SPPConfidence',
    'SAFT44kHz16BitMono', 'SpUnCompressedLexicon',
    'eLEXTYPE_PRIVATE20', 'ISpPhrase', 'SVEWordBoundary',
    'DISPID_SRGState', 'eLEXTYPE_PRIVATE11', 'SPRECORESULTTIMES',
    'SVP_18', 'DISPID_SPEDisplayText', 'SPINTERFERENCE_TOOSLOW',
    'SPRECOCONTEXTSTATUS', 'ISpXMLRecoResult', 'ISpRecoGrammar2',
    'SPPS_LMA', 'DISPID_SGRSAddWordTransition',
    'SAFTGSM610_44kHzMono', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPEI_END_INPUT_STREAM', 'SVSFParseMask', 'SPCS_DISABLED',
    'SRAORetainAudio', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFTGSM610_11kHzMono', 'SPPS_Function',
    'IInternetSecurityManager', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_RESERVED2', 'SRESoundEnd', 'DISPID_SPRuleId',
    'SPEI_MIN_TTS', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPPId',
    'SDTDisplayText', 'SPAUDIOOPTIONS', 'DISPID_SVESentenceBoundary',
    'SpAudioFormat', 'SDTLexicalForm', 'SpeechAudioFormatGUIDWave',
    'SDKLLocalMachine', 'SAFTADPCM_44kHzMono', 'SPLO_DYNAMIC',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SLPLangId', 'SVEVoiceChange',
    'SPAR_Low', 'ISpEventSource', 'DISPID_SBSSeek',
    'ISpeechTextSelectionInformation', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechPhraseElement', 'SDA_No_Trailing_Space',
    'SPRULESTATE', 'SPLOADOPTIONS', 'SGRSTTDictation',
    'DISPID_SWFEExtraData', 'DISPID_SVWaitUntilDone',
    'DISPID_SLWType', 'SpeechRecoProfileProperties',
    'SRSInactiveWithPurge', 'ISpeechPhraseAlternate', 'SPEI_MAX_SR',
    'SP_VISEME_7', 'DISPID_SLAddPronunciation', 'SPFM_NUM_MODES',
    ...
    'DISPID_SVRate', 'SPAO_RETAIN_AUDIO', 'SAFT48kHz8BitMono',
    'DISPID_SGRSTText', 'tagSPPROPERTYINFO', 'SVEAudioLevel',
    'DISPID_SOTCGetDataKey', 'SINoise', 'SPPS_Interjection',
    'ISpObjectTokenCategory', 'DISPID_SPIRule',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechPhraseProperties', 'SPSHT_Unknown',
    'SPWAVEFORMATTYPE', 'STCInprocServer', 'eLEXTYPE_RESERVED9',
    'DISPID_SRRecognizer', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SRGCmdSetRuleState', 'eLEXTYPE_PRIVATE13',
    'SPWORDPRONOUNCEABLE', 'SPCONTEXTSTATE', 'SRSActiveAlways',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRGSetTextSelection', 'DISPID_SGRClear',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechGrammarRuleState', 'SVP_12',
    'SGDSActive', 'DISPID_SOTRemove', 'DISPID_SVEWord',
    'DISPID_SVEViseme', 'SpeechEngineConfidence', 'SDKLCurrentUser',
    'DISPID_SPEActualConfidence', 'ISpNotifyTranslator',
    'SpeechGrammarState', 'DISPID_SRGIsPronounceable',
    'SPEI_SENTENCE_BOUNDARY', '_ISpeechVoiceEvents',
    'DISPID_SPIGrammarId', 'ISpRecoCategory', 'DISPID_SLPPhoneIds',
    'SECNormalConfidence', 'ISpeechMMSysAudio',
    'SAFTGSM610_22kHzMono', 'SVSFDefault', 'SpeechVisemeType',
    'DISPID_SRCEBookmark', 'SPRS_ACTIVE', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechObjectToken', 'SpPhraseInfoBuilder', 'SASRun',
    'SpeechCategoryRecognizers', 'SpResourceManager',
    'eLEXTYPE_PRIVATE4', 'SPEI_INTERFERENCE', 'SRSEIsSpeaking',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPELexicalForm', 'SRSInactive',
    'DISPID_SAFSetWaveFormatEx', 'ISpeechPhraseRule',
    'SpeechTokenKeyUI', 'SAFT11kHz8BitMono', 'SPEVENT', 'SpShortcut',
    'SVSFIsNotXML', 'DISPID_SPEEngineConfidence',
    'SPDKL_LocalMachine', 'SPPS_Unknown', 'SPINTERFERENCE_NOISE',
    'IStream', 'SpeechEngineProperties', 'DISPID_SPRuleFirstElement',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechLexiconProns', 'ISpShortcut',
    'SpeechRecoContextState', 'SpeechAddRemoveWord',
    'DISPID_SWFEChannels', 'SVEEndInputStream', 'SVPAlert',
    'SRTAutopause', 'SLODynamic',
    'SpeechPropertyHighConfidenceThreshold', 'eLEXTYPE_PRIVATE12',
    'SPEI_UNDEFINED', 'ISpeechCustomStream', 'DISPID_SGRs_NewEnum',
    'DISPID_SRCERecognizerStateChange', 'SVP_16', 'SP_VISEME_9',
    'eLEXTYPE_PRIVATE18', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SGRAttributes', 'SVP_21', 'DISPID_SDKEnumValues',
    'DISPID_SRGRecoContext', 'DISPID_SVEStreamStart', 'SPVPRI_ALERT',
    'SpLexicon', 'SDKLDefaultLocation', 'SpeechDataKeyLocation',
    'SAFTCCITT_uLaw_8kHzMono', 'SPRULE',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPEAudioTimeOffset',
    'eLEXTYPE_LETTERTOSOUND', 'eLEXTYPE_PRIVATE8', 'DISPID_SGRsCount',
    'SVP_17', 'SP_VISEME_20', 'DISPID_SpeechLexiconWord',
    'DISPID_SRGetRecognizers', 'SPXRO_SML',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SBSWrite',
    'ISpeechVoiceStatus', 'ISpeechPhraseElements',
    'DISPID_SDKDeleteValue', 'SVSFIsXML', 'DISPID_SPRules_NewEnum',
    'DISPID_SRSNumberOfActiveRules', 'SPAS_PAUSE', 'SPAS_RUN',
    'DISPID_SPEPronunciation', 'SPINTERFERENCE_NOSIGNAL',
    'SPEI_RESERVED1', 'SVP_0', 'SPPS_RESERVED1',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SLGetWords',
    'SDTReplacement', 'SPWT_LEXICAL', 'DISPID_SWFEBlockAlign',
    'DISPID_SPPName', 'SFTInput', 'SpObjectToken',
    'SVSFPurgeBeforeSpeak', 'SVSFNLPMask', 'DISPID_SpeechBaseStream',
    'SVP_9', 'ISpeechGrammarRuleStateTransition', 'SDTRule',
    'SECFIgnoreKanaType', 'DISPID_SADefaultFormat',
    ...
    'ISpeechLexiconWords', 'SpeechTokenValueCLSID', 'DISPID_SOTCId',
    'DISPID_SpeechGrammarRules', 'SVP_8', 'SpeechRecognizerState',
    'DISPID_SRGetFormat', 'DISPID_SDKDeleteKey',
    ...
    'SPSInterjection', 'ISpRecoContext', 'DISPID_SRCEventInterests',
    'DISPID_SRGDictationUnload',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_TTS_PRIVATE', 'DISPID_SpeechPhraseProperty',
    '__MIDL_IWinTypes_0009', 'ISpProperties',
    'DISPID_SpeechLexiconPronunciation', 'SpeechMicTraining',
    'SVSFVoiceMask', 'DISPID_SPRFirstElement', 'SVEPhoneme',
    'ISpResourceManager', 'DISPID_SpeechAudio', 'SPSHT_OTHER',
    'SAFT16kHz16BitStereo', 'SREAudioLevel',
    '_ISpeechRecoContextEvents', 'SP_VISEME_16', 'DISPID_SRIsShared',
    'Speech_StreamPos_RealTime', 'eLEXTYPE_APP',
    'DISPID_SDKSetLongValue', 'ISpeechPhraseElement',
    'DISPID_SRCEAdaptation', 'SPEI_SOUND_END', 'SPFM_CREATE',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechAudio',
    'SpeechPropertyResponseSpeed', 'DISPID_SVEAudioLevel',
    'DISPID_SDKEnumKeys', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPRuleName', 'DISPID_SpeechRecoResult2',
    'IEnumSpObjectTokens', 'DISPID_SGRSTransitions',
    'DISPID_SRCVoicePurgeEvent', 'SVP_20', 'SGDSInactive',
    'SP_VISEME_15', 'ISpRecoResult', 'SPAR_Unknown', 'SPLEXICONTYPE',
    'ISpeechLexiconWord', 'SECFDefault', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPRs_NewEnum', 'DISPID_SOTIsUISupported',
    'SRERecoOtherContext', 'DISPID_SPPsItem', 'SPCT_SUB_DICTATION',
    'DISPID_SRCEEndStream', 'ISpeechPhraseProperty',
    'DISPID_SRCESoundStart', 'SAFTADPCM_22kHzStereo', 'SPBO_NONE',
    'SPEI_RESERVED6', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechAudioBufferInfo', 'ISpeechPhraseRules',
    'SpeechEmulationCompareFlags', 'DISPID_SOTRemoveStorageFileName',
    'SPPS_RESERVED2', 'DISPID_SRCCreateResultFromMemory',
    'SPTEXTSELECTIONINFO', 'SpeechAudioVolume', 'DISPID_SOTDataKey',
    'SpeechDictationTopicSpelling', 'ISpAudio', 'DISPID_SPACommit',
    'eLEXTYPE_PRIVATE16', 'STCInprocHandler', 'DISPID_SGRsFindRule',
    'SPBO_TIME_UNITS', 'SPWORD', 'DISPID_SGRsItem',
    ...
    'DISPID_SPPNumberOfElements', 'DISPID_SPIGetText', 'SPBO_AHEAD',
    'SPCS_ENABLED', 'DISPID_SRGId', 'DISPID_SGRSTWeight',
    'DISPID_SGRId', 'DISPID_SOTsCount', 'ISpRecoContext2',
    'SAFT24kHz16BitMono', 'DISPID_SpeechRecognizerStatus',
    'SpSharedRecognizer', 'SP_VISEME_18', 'SPWF_INPUT',
    'SpPhoneticAlphabetConverter', 'SVESentenceBoundary',
    'DISPID_SVSpeak', 'DISPID_SPRuleConfidence', 'SECLowConfidence',
    'DISPID_SAStatus', 'SpWaveFormatEx', 'DISPID_SDKOpenKey',
    'SPXRO_Alternates_SML', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRSClsidEngine', 'DISPID_SPIReplacements',
    'SAFT44kHz16BitStereo', 'SPCT_SUB_COMMAND',
    'DISPID_SWFEFormatTag', 'DISPID_SRCEAudioLevel', 'SPSModifier',
    'SRADefaultToActive', 'DISPID_SLRemovePronunciation',
    'SAFT12kHz16BitMono', 'SRERecognition',
    'DISPID_SVSInputWordLength', 'SVEBookmark', 'SVEAllEvents',
    'SpeechWordPronounceable', 'DISPID_SOTCategory',
    'eLEXTYPE_RESERVED7', 'SPPHRASE', 'ISpeechMemoryStream',
    'ISpeechRecoResult2', 'SpStream', 'SAFTDefault',
    'DISPID_SGRsCommit', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SGSEnabled', 'DISPID_SRCRetainedAudio', 'SpMemoryStream',
    ...
    'SREStreamStart', 'SVSFPersistXML', 'SGRSTTTextBuffer',
    'ISpNotifySource', 'SGPronounciation',
    'DISPIDSPTSI_SelectionOffset', 'SGRSTTEpsilon', 'SP_VISEME_10',
    'DISPID_SRGDictationSetState', 'SPRST_ACTIVE', 'DISPID_SLPType',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVGetVoices',
    'ISpRecognizer', 'DISPID_SABufferNotifySize',
    'DISPID_SWFEAvgBytesPerSec', 'SSFMOpenForRead',
    'DISPID_SpeechMMSysAudio', 'DISPID_SDKGetBinaryValue',
    'SREBookmark', 'DISPID_SLWPronunciations', 'SAFT24kHz16BitStereo',
    'SPPS_Verb', 'SVPOver', 'DISPID_SRCBookmark',
    'SpeechUserTraining', 'DISPID_SABufferInfo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpMMSysAudio',
    'ISpGrammarBuilder', 'DISPID_SOTGetDescription', 'DISPID_SVSkip',
    'DISPID_SLWLangId', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechDiscardType', 'SpeechGrammarTagDictation',
    'DISPID_SASCurrentDevicePosition', 'SDTAlternates', 'SITooSlow',
    'SPPS_Modifier', 'SGRSTTWord', 'DISPID_SBSRead',
    'DISPID_SRCSetAdaptationData',
    'SpeechPropertyNormalConfidenceThreshold', 'eWORDTYPE_DELETED',
    'DISPID_SPAsCount', 'SWTAdded', 'DISPID_SRRTLength', 'SVP_10',
    'DISPID_SPPParent', 'SPPHRASEELEMENT', 'SPFM_OPEN_READONLY',
    'SpeechRegistryUserRoot', 'DISPID_SPISaveToMemory', 'SVPNormal',
    'SVP_1', 'DISPID_SFSClose', 'DISPID_SOTsItem', 'SPEI_MAX_TTS',
    'eLEXTYPE_USER', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechAudioFormat', 'SAFT32kHz16BitMono', 'SLTApp',
    'DISPID_SASNonBlockingIO', 'SPSHT_EMAIL',
    'ISpeechObjectTokenCategory', 'ISpeechPhraseInfoBuilder',
    'DISPID_SVEVoiceChange', 'SPSSuppressWord', 'SPVISEMES',
    'DISPID_SRRTStreamTime', 'SPSEMANTICFORMAT', 'SPEVENTSOURCEINFO',
    'SpeechGrammarRuleStateTransitionType', 'SP_VISEME_0',
    'DISPID_SPPEngineConfidence', 'SAFT11kHz16BitMono',
    'DISPID_SVSpeakStream', 'SWTDeleted',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SDKGetlongValue',
    'SAFT8kHz8BitStereo', 'DISPID_SRStatus', 'SPPS_RESERVED3',
    'SVEViseme', 'DISPID_SRCState', 'SpPhoneConverter',
    'SPFM_OPEN_READWRITE', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPAPhraseInfo',
    'DISPID_SPIElements', 'DISPID_SPILanguageId', 'ISpeechPhraseInfo',
    'SRCS_Enabled', 'SPAO_NONE', 'DISPID_SPRulesItem', 'WAVEFORMATEX',
    'DISPID_SVSLastBookmark', 'SRTEmulated',
    'DISPID_SRCEFalseRecognition', 'SpeechRetainedAudioOptions',
    'SBOPause', 'DISPID_SVGetAudioOutputs', 'SPBINARYGRAMMAR',
    ...
    'DISPID_SPRuleParent', 'DISPID_SRState', 'SREPrivate',
    'DISPID_SRCEHypothesis', 'SPSVerb', 'SVSFNLPSpeakPunc',
    'DISPID_SLWs_NewEnum', 'SVF_None', 'SPEI_MIN_SR',
    'SPEI_WORD_BOUNDARY', 'SPWF_SRENGINE', 'DISPID_SABIBufferSize',
    'SPWORDPRONUNCIATION', 'SECFEmulateResult', 'SRTExtendableParse',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVEBookmark',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVP_15',
    'DISPID_SPANumberOfElementsInResult', 'SAFT11kHz16BitStereo',
    'SPEI_FALSE_RECOGNITION', 'SRERequestUI', 'SPWORDTYPE', 'SVP_5',
    'eLEXTYPE_PRIVATE10', 'IEnumString',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SGRSTsItem',
    'DISPID_SVSRunningState', 'SPAS_CLOSED', 'SAFT24kHz8BitMono',
    'SGLexical', 'DISPID_SRCRecognizer', 'SRAInterpreter',
    'SINoSignal', 'ISpEventSink', 'DISPID_SPIEngineId',
    'DISPID_SLPsItem', 'ISpeechXMLRecoResult',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechRunState', 'SDTProperty',
    'DISPID_SGRSTPropertyId', 'SpNullPhoneConverter',
    'eLEXTYPE_PRIVATE2', 'SPEI_START_SR_STREAM', 'ISpeechGrammarRule',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpeechGrammarRules',
    'LONG_PTR', 'SPPS_Noncontent', 'eLEXTYPE_RESERVED6',
    'DISPID_SRAudioInput', 'DISPID_SRRAudioFormat',
    'DISPID_SDKCreateKey', 'SpeechVoiceSkipTypeSentence',
    'SREInterference', 'SpeechGrammarWordType',
    'DISPID_SRSAudioStatus', 'SpInProcRecoContext',
    'DISPID_SOTGetAttribute', 'SpeechAllElements', 'SpMMAudioIn',
    'DISPID_SpeechRecoResultTimes', 'SPSMF_SRGS_SAPIPROPERTIES',
    'STCLocalServer', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRCCreateGrammar', 'eWORDTYPE_ADDED',
    'DISPID_SGRSTPropertyName', 'ISpSerializeState', 'SVP_6',
    'SDTAudio', 'SpeechTokenKeyFiles', 'SPPARTOFSPEECH',
    'SPSHORTCUTTYPE', '_SPAUDIOSTATE', 'SITooLoud', 'DISPID_SPRText',
    'SP_VISEME_5', 'SpVoice', 'SPGS_EXCLUSIVE',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_PRIVATE19',
    'DISPID_SAFType', 'ISpObjectToken', 'DISPID_SGRsAdd', 'SPSMF_UPS',
    'SRSEDone', 'SAFTNoAssignedFormat', 'SAFT32kHz8BitStereo',
    'SAFT48kHz16BitMono', 'DISPID_SVEPhoneme', 'STSF_FlagCreate',
    'SPWORDLIST', 'DISPID_SRRAlternates', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCESoundEnd', 'SAFTADPCM_11kHzMono', 'SPAUDIOSTATUS',
    'DISPID_SPEAudioSizeBytes', 'SPEI_RESERVED5', 'SDKLCurrentConfig',
    'SPEI_ADAPTATION', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechSpecialTransitionType', 'SREPhraseStart', 'SREAllEvents',
    'tagSPTEXTSELECTIONINFO', 'Speech_Max_Pron_Length',
    'SPGS_DISABLED', 'DISPID_SRIsUISupported',
    'DISPID_SpeechGrammarRule', 'SP_VISEME_17',
    'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPCLangId',
    'ISpeechPhoneConverter', 'ISpeechAudioFormat',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SLWsItem',
    'SPEI_SR_PRIVATE', 'SpeechCategoryAudioIn',
    'SpeechStreamFileMode', 'SPVPRI_OVER', 'SAFT8kHz8BitMono',
    'DISPID_SABIEventBias', 'SVP_19', 'SPAR_High',
    'DISPID_SVGetProfiles', 'SP_VISEME_11', 'DISPID_SVEStreamEnd',
    'SPEI_TTS_AUDIO_LEVEL', 'SPSEMANTICERRORINFO', 'SAFTText',
    'SFTSREngine', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_RESERVED8',
    'DISPID_SGRsCommitAndSave', 'tagSTATSTG',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPIDSPRG'
]

_check_version('1.1.14', 1653650319.449795)
